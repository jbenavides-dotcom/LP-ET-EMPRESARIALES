    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-white">
      <div ref={reveal.ref} className={`max-w-7xl mx-auto px-4 sm:px-6 ${reveal.isVisible ? 'scroll-visible' : 'scroll-hidden'}`}>
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-neutral-600 font-light text-sm sm:text-base">Acompañamos el diseño de tu experiencia, de acuerdo a las necesidades de tu organización, alineados con los objetivos de tu empresa.</p>
        </div>
