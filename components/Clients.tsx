    ...
    <section className="py-16 sm:py-24 lg:py-32 bg-white">
      <div ref={reveal.ref} className={`max-w-7xl mx-auto px-4 sm:px-6 ${reveal.isVisible ? 'scroll-visible' : 'scroll-hidden'}`}>
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
          <h4 className="text-brand-pink text-xs uppercase tracking-[0.4em] font-bold mb-3 sm:mb-4">{t('clients_eyebrow')}</h4>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-brand-dark mb-4 sm:mb-6">{t('clients_title')}</h2>
          <p className="text-neutral-600 font-light text-sm sm:text-base">{t('clients_subtitle')}</p>
        </div>
